...
ENT.Base = "base_planter" -- Specifies that this Entity is based on the 'base_gmodentity', inheriting its functionality.
ENT.PrintName = "Large Planter" -- The name that will appear in the spawn menu.
...
--Water Amount
ENT.DefaultWaterAmount = 90
ENT.MaxWaterAmount = 360