...
ENT.Base = "base_seeds"
ENT.PrintName = "Pumpkin Seeds" -- The name that will appear in the spawn menu.
...
ENT.SeedIcon = Material("icons/seedPacks/pumpkinIcon.png")
ENT.DefaultSeedAmount = 5 -- default amount

--Seeds
ENT.GrowTime = 560
ENT.CropClassName = "Pumpkins"
ENT.CropAmount = 1
ENT.CropMaxAmount = 2
