...
ENT.Base = "base_seeds"
ENT.PrintName = "Strawberry Seeds" -- The name that will appear in the spawn menu.
...
ENT.SeedIcon = Material("icons/seedPacks/strawberryIcon.png")
ENT.DefaultSeedAmount = 5 -- default amount

--Seeds
ENT.GrowTime = 520
ENT.CropClassName = "Strawberries"
ENT.CropAmount = 1
ENT.CropMaxAmount = 2
